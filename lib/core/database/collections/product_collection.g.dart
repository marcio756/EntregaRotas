...
void _productSerialize(
  ...
  writer.writeLong(offsets[1], object.defaultQuantity);
...
Product _productDeserialize(
  ...
  object.defaultQuantity = reader.readLongOrNull(offsets[1]);
  object.id = id;
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> defaultQuantityEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'defaultQuantity',
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> defaultQuantityLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> defaultQuantityBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitPriceIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitPriceIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'unitPrice',
      ));
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitPriceEqualTo(
    double? value, {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitPriceGreaterThan(
    double? value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitPriceLessThan(
    double? value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> unitPriceBetween(
    double? lower,
    double? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByDefaultQuantity() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultQuantity', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByDefaultQuantityDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByUnitPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unitPrice', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByUnitPriceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByDefaultQuantity() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultQuantity', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByDefaultQuantityDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultQuantity', Sort.desc);
    });
  }
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByUnitPrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unitPrice', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByUnitPriceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'unitPrice', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByDefaultQuantity() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByUnitPrice() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, int?, QQueryOperations> defaultQuantityProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, double?, QQueryOperations> unitPriceProperty() {
    return QueryBuilder.apply(this, (query) {
